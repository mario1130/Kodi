...
#############Defined Strings#############
ADDONTITLE	= 'MyTV Digital'
addon_id	= 'plugin.video.digitalv3'
...
host		= base64.b64decode('aHR0cDovL215dHYuZGlnaXRhbA==').decode('utf-8')
port		= base64.b64decode('ODA=').decode('utf-8')
